    ...
    <div class="flex flex-col gap-8">
        ...
        <div class="bg-white rounded-xl p-8 border-3 border-black shadow-[8px_8px_0px_rgba(0,0,0,1)]">
            ...
            <p class="text-gray-600 text-lg">
                Siap untuk memasak sesuatu yang lezat hari ini? Mulai dengan mengunggah foto bahan makananmu atau lihat
                riwayat masakan sebelumnya.
            </p>
        </div>
        ...
        <div class="bg-white rounded-xl p-8 border-3 border-black shadow-[8px_8px_0px_rgba(0,0,0,1)]">
            ...
            <div class="flex flex-col gap-4">
                @forelse ($analyses as $analysis)
                    ...
                    <div
                        class="flex flex-col md:flex-row items-start md:items-center gap-4 p-4 border-3 border-black rounded-xl bg-[#fcf9f8]">
                        <div
                            class="w-full md:w-24 h-40 md:h-24 bg-gray-200 border-2 border-black rounded-lg overflow-hidden shrink-0">
                        ...
                        <div class="grow w-full md:w-auto">
                            ...
                            <div class="flex flex-wrap items-center gap-3">
                                @if ($firstRec)
                                    <span
                                        class="bg-green-300 text-green-900 text-xs font-bold px-3 py-1 border-2 border-black rounded-md shadow-[2px_2px_0px_rgba(0,0,0,1)]">
                                        {{ $firstRec->difficulty }}
                                    </span>
                                @endif
                        ...
                        <div class="w-full md:w-auto mt-2 md:mt-0">
                            <a href="{{ route('riwayat.show', $analysis) }}"
                                class="block w-full md:w-auto text-center px-5 py-2.5 bg-yellow-400 font-bold border-2 border-black rounded-md shadow-[3px_3px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[5px_5px_0px_rgba(0,0,0,1)] transition-all">Lihat
                                Detail</a>
                        </div>
                    </div>
                @empty
